...
export default function AccountStep({ onComplete, savedData, onSave }) {
  const [fields, setFields] = useState(
    savedData
      ? { firstName: savedData.firstName, lastName: savedData.lastName, email: savedData.email, username: savedData.username, password: '', confirm: '' }
      : EMPTY
  );
    ...
    <Box component="form" onSubmit={handleSubmit} noValidate>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        {isUpdate
          ...
          : "Create the administrator account you'll use to log in to Makeventory."}
      </Typography>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={6}>
          <TextField
            ...
            fullWidth required={!isUpdate} size="small"
            disabled={submitting || done}
            InputProps={{
              endAdornment: (
